...
class QuestionBankItem(Base):
    """Reusable, syllabus-versioned MCQ generated by the question provider."""

    __tablename__ = "question_bank_items"
    __table_args__ = (
        UniqueConstraint(
            "exam_type", "format_version", "fingerprint",
            name="uq_question_bank_exam_version_fingerprint",
        ),
    )
    ...
    topic = Column(String(150), nullable=False, default="", index=True)
    difficulty = Column(String(20), nullable=False, index=True)
    format_version = Column(String(80), nullable=False, index=True)
    fingerprint = Column(String(64), nullable=False, index=True)
    question = Column(JSON, nullable=False)
    source_type = Column(String(40), nullable=False, default="gemini_generated")
